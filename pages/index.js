...
export default function Home() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want what do you want Lorem ipsum dolor sit amet consectetur adipisicing elit. Et odio iusto ullam doloremque qui. Possimus voluptates doloribus exercitationem nihil quae?.</p>
    </div>
